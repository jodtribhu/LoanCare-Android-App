...
public class CuurencyWatcher implements TextWatcher {
    private EditText ed;
    ...
    public CuurencyWatcher(EditText ed) {
        this.ed = ed;
    }

    public static String getStringWithSeparator(long value) {
        DecimalFormat formatter = (DecimalFormat) NumberFormat.getNumberInstance(new Locale("en", "IN"));
